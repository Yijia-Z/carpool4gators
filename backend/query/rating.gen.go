...
func newRating(db *gorm.DB, opts ...gen.DOOption) rating {
	...
	_rating.DriverID = field.NewInt64(tableName, "driver_id")
	_rating.UserID = field.NewString(tableName, "user_id")
	_rating.Rating = field.NewFloat64(tableName, "rating")
	_rating.Comment = field.NewString(tableName, "comment")
	_rating.Timestamp = field.NewInt64(tableName, "timestamp")
...
func (r *rating) updateTableName(table string) *rating {
	...
	r.DriverID = field.NewInt64(table, "driver_id")
...
func (r *rating) WithContext(ctx context.Context) IRatingDo { return r.ratingDo.WithContext(ctx) }

func (r rating) TableName() string { return r.ratingDo.TableName() }

func (r rating) Alias() string { return r.ratingDo.Alias() }
...
func (r *rating) fillFieldMap() {
	...
	r.fieldMap["driver_id"] = r.DriverID
